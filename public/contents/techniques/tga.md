...
output: "weight loss as a function of temperature"
tags:
  - technique/tga
sources:
...
**Summary**: A technique used to quantify the amount of volatile components or thermal decomposition in a material.

---

## How It Is Used in the Thesis Collection

- [[2014-adebayo|Adebayo, 2014]] applied TGA to determine the thermal stability and composition of fly ash samples.

- [[2015-danmaliki|Danmaliki, 2015]] used TGA to evaluate the thermal stability of the activated carbon samples.
...
- Used to analyze the thermal behavior of raw, acid-treated, and metal oxide impregnated fly ash. ([[2014-adebayo|Adebayo, 2014, p. 40]])

- TGA analysis was performed on AC-HNO3-90°C to determine its thermal properties. ([[2015-danmaliki|Danmaliki, 2015, p. 92]])
