...
output: "specific surface area and pore volume"
tags:
  - technique/bet
sources:
...
**Summary**: A method for determining the specific surface area and pore size distribution of porous materials.

---

## How It Is Used in the Thesis Collection

- [[2014-adebayo|Adebayo, 2014]] used BET to characterize the surface area of modified and non-modified fly ash samples.
...
- Used to determine the surface area of various fly ash types (raw, acid treated, and metal oxide impregnated). ([[2014-adebayo|Adebayo, 2014, p. 31]])
