...
output: "lithology classification (shale, shaly sand, sandstone)"
tags:
  - technique/ann
  - theme/petrophysics
sources:
...
**Summary**: A computational model that mimics biological neural networks to find non-linear relationships between input and output data.

---

## How It Is Used in the Thesis Collection

- [[2013-el-kheir|El-Kheir, 2013]] used ANN to classify lithological facies based on well log parameters (GR, DT, NPHI, RHOZ, RLA5).
