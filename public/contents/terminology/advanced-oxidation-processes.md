...
aliases:
  - "AOP"
canonical: true
definition: "Oxidation processes characterized by the formation of hydroxyl radicals (OH•)."
...
**Summary**: Chemical treatment methods involving the production of hydroxyl radicals to oxidize organic contaminants.

---

## How It Appears in the Thesis Collection

- [[2009-zubair|Zubair, 2009]] evaluated advanced oxidation processes (AOP) for the removal of phenol and management of bromate formation.
...
- [[2009-zubair|Zubair, 2009]] Comparison of different AOP configurations (UV/O3, O3/H2O2).

## Key Findings Across Sources

- Ozone-based AOP techniques are effective for degrading a wide range of micro-organisms and organic molecules. ([[2009-zubair|Zubair, 2009, p. 16]])
