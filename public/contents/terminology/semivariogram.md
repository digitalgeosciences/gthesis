...
aliases: []
canonical: true
definition: "A function that describes the variance of the difference between two points as a function of the distance between them."
...
**Summary**: A tool used in geostatistics to quantify the spatial correlation of data.

---

## How It Appears in the Thesis Collection

- [[1996-jarad|Jarad, 1996]] constructed semivariograms for P20% in different directions.
...
- [[1996-jarad|Jarad, 1996]] Constructed from drill-hole data for P20%, thickness, and accumulation.

## Key Findings Across Sources

- Spherical models were determined from semivariograms for use in kriging and conditional simulation. ([[1996-jarad|Jarad, 1996, p. 91]])
...
- [[1996-jarad|Jarad, 1996]] Spherical models were selected as the best fit.
